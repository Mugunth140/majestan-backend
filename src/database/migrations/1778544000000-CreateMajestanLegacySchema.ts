  ...
  },
  {
    ...
    indexes: [
      ...
      },
      {
        ...
        columns: ['property_id', 'property_type'],
        unique: false,
      },
    ],
  },
  ...
  },
  {
    ...
    indexes: [
      ...
      },
      {
        ...
        columns: ['buildup_area'],
        unique: false,
      },
      {
        name: 'idx_industrial_age_of_property',
        columns: ['age_of_property'],
        unique: false,
      },
      {
...
export class CreateMajestanLegacySchema1778544000000 implements MigrationInterface {
